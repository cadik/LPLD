#ifndef DIP_MASK_ENTROPY_MULTI_HPP
#define DIP_MASK_ENTROPY_MULTI_HPP
...
namespace dip {
    class MASK_ENT_MULTI : public methodStrategy {
    public:
        MASK_ENT_MULTI(cv::Mat &testImg, cv::Mat &referenceImg, int level, int platformNum, cl_device_type deviceType, int deviceNum) throw (std::runtime_error);
