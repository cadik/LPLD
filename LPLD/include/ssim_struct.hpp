#ifndef DIP_SSIM_STRUCT_HPP
#define DIP_SSIM_STRUCT_HPP
...
namespace dip {
    class SSIM_STRUCT : public methodStrategy {
    public:
        // Constructor
        SSIM_STRUCT(cv::Mat &testImg, cv::Mat &referenceImg, int platformNum = 0, \
